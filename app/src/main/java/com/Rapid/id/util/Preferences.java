...
public class Preferences {
    ...
    static final String KEY_NAMA_TEREGISTER ="nama", KEY_ID_TEREGISTER ="id",KEY_EMAIL_TEREGISTER ="email";
    ...
    public static void setLoggedInNama(Context context, String nama){
        SharedPreferences.Editor editor = getSharedPreference(context).edit();
        editor.putString(KEY_USERNAME_SEDANG_LOGIN, nama);
        editor.apply();
    }
    ...
    public static void setLoggedInId(Context context, String id){
        SharedPreferences.Editor editor = getSharedPreference(context).edit();
        editor.putString(KEY_ID_SEDANG_LOGIN, id);
        editor.apply();
    }
    /** Mengembalikan nilai dari key KEY_USERNAME_SEDANG_LOGIN berupa String */
    public static String getLoggedInId(Context context){
        return getSharedPreference(context).getString(KEY_ID_SEDANG_LOGIN,"");
    }
    ...
    public static void clearLoggedInNama (Context context){
        SharedPreferences.Editor editor = getSharedPreference(context).edit();
    ...
    public static void clearLoggedInId (Context context){
        SharedPreferences.Editor editor = getSharedPreference(context).edit();
        editor.remove(KEY_ID_SEDANG_LOGIN);
        editor.remove(KEY_STATUS_SEDANG_LOGIN);
        editor.apply();
    }
    public static void clearLoggedInEmail (Context context){
        SharedPreferences.Editor editor = getSharedPreference(context).edit();
