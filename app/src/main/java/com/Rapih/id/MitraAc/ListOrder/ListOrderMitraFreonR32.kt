...
import com.Rapih.id.MitraAc.DetailOrder.DetailOrderMitraFreonR32
...
class ListOrderMitraFreonR32 :AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.list_freon_r32_mitra)

        Rak.initialize(this)

        urlac = "http://rapih.id/api/freon_r32/listorderfreonr32mitra.php"
        Log.d("TAG", urlac)

        lstHistoriac = findViewById(R.id.rvListOrderFreonR32AcMitra) as RecyclerView

        pglistac = findViewById(R.id.progressBarFreonR32AcMitra) as ProgressBar

        swipeRefreshLayout = findViewById(R.id.swipeorderfreonr32acmitra)
    ...
    fun ambilListOrder() {
        ...
        val request = StringRequest(Request.Method.GET, urlac, onPostsLoaded, object : Response.ErrorListener {
            override fun onErrorResponse(error: VolleyError?) {
                ...
                var inetErr: AlertDialog.Builder = AlertDialog.Builder(this@ListOrderMitraFreonR32)
                ...
                try {
                    ...
                    adapter!!.setListener(object: ItemClickListener<OrderKonsumenAc> {
                        override fun onClicked(OrderKonsumenAc: OrderKonsumenAc?, position: Int, view: View?) {
                            ...
                            val intent = Intent(this@ListOrderMitraFreonR32, DetailOrderMitraFreonR32::class.java)
