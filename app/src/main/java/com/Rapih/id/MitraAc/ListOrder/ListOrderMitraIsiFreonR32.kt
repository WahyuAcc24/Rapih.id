...
import com.Rapih.id.MitraAc.DetailOrder.*
...
class ListOrderMitraIsiFreonR32 :AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.list_isi_freon_r32_mitra)

        Rak.initialize(this)

        urlac = "http://rapih.id/api/isi_freon_r32/listorderisifreonr32mitra.php"
        Log.d("TAG", urlac)

        lstHistoriac = findViewById(R.id.rvListOrderIsiFreonR32AcMitra) as RecyclerView

        pglistac = findViewById(R.id.progressBarIsiFreonR32AcMitra) as ProgressBar

        swipeRefreshLayout = findViewById(R.id.swipeorderisifreonr32acmitra)
    ...
    fun ambilListOrder() {
        ...
        val request = StringRequest(Request.Method.GET, urlac, onPostsLoaded, object : Response.ErrorListener {
            override fun onErrorResponse(error: VolleyError?) {
                ...
                var inetErr: AlertDialog.Builder = AlertDialog.Builder(this@ListOrderMitraIsiFreonR32)
                ...
                try {
                    ...
                    adapter!!.setListener(object: ItemClickListener<OrderKonsumenAc> {
                        override fun onClicked(OrderKonsumenAc: OrderKonsumenAc?, position: Int, view: View?) {
                            ...
                            val intent = Intent(this@ListOrderMitraIsiFreonR32, DetailOrderMitraIsiFreonR32::class.java)
