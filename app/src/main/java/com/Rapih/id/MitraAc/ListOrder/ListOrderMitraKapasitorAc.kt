...
import com.Rapih.id.MitraAc.DetailOrder.DetailOrderMitraKapasitorAc
...
class ListOrderMitraKapasitorAc :AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.list_kapasitor_mitra)

        Rak.initialize(this)

        urlac = "http://rapih.id/api/kapasitor_ac/listorderkapasitormitra.php"
        Log.d("TAG", urlac)

        lstHistoriac = findViewById(R.id.rvListOrderKapasitorAcMitra) as RecyclerView

        pglistac = findViewById(R.id.progressBarKapasitorAcMitra) as ProgressBar

        swipeRefreshLayout = findViewById(R.id.swipeorderkapasitoracmitra)
    ...
    fun ambilListOrder() {
        ...
        val request = StringRequest(Request.Method.GET, urlac, onPostsLoaded, object : Response.ErrorListener {
            override fun onErrorResponse(error: VolleyError?) {
                ...
                var inetErr: AlertDialog.Builder = AlertDialog.Builder(this@ListOrderMitraKapasitorAc)
                ...
                try {
                    ...
                    adapter!!.setListener(object: ItemClickListener<OrderKonsumenAc> {
                        override fun onClicked(OrderKonsumenAc: OrderKonsumenAc?, position: Int, view: View?) {
                            ...
                            val intent = Intent(this@ListOrderMitraKapasitorAc, DetailOrderMitraKapasitorAc::class.java)
