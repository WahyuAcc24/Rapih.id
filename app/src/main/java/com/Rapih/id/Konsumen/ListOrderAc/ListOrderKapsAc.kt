...
import com.Rapih.id.Konsumen.DetailOrderAC.DetailOrderKapsAcKonsumen
...
class ListOrderKapsAc :AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.list_kapasitor_ac)

        Rak.initialize(this)

        urlac = "http://rapih.id/api/kapasitor_ac/listorderkapasitorkonsumen.php?id_konsumen_ac= " + Rak.grab("idkonsumen")

        Log.d("TAG", urlac)

        lstHistoriac = findViewById(R.id.rvListOrderKapasitorAc) as RecyclerView

        pglistac = findViewById(R.id.progressBarKapasitorAc) as ProgressBar

        swipeRefreshLayout = findViewById(R.id.swipeorderkapasitorac)
    ...
    fun ambilListOrder() {
        ...
        val request = StringRequest(Request.Method.GET, urlac, onPostsLoaded, object : Response.ErrorListener {
            override fun onErrorResponse(error: VolleyError?) {
                ...
                var inetErr: AlertDialog.Builder = AlertDialog.Builder(this@ListOrderKapsAc)
                ...
                try {
                    ...
                    adapter!!.setListener(object: ItemClickListener<OrderKonsumenAc> {
                        override fun onClicked(OrderKonsumenAc: OrderKonsumenAc?, position: Int, view: View?) {
                            ...
                            val intent = Intent(this@ListOrderKapsAc, DetailOrderKapsAcKonsumen::class.java)
