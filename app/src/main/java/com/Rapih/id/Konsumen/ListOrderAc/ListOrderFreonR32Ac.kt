...
import com.Rapih.id.Konsumen.DetailOrderAC.DetailOrderFreonR32Konsumen
...
class ListOrderFreonR32Ac :AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.list_freon_r32_ac)

        Rak.initialize(this)
        urlac = "http://rapih.id/api/freon_r32/listorderfreonr32konsumen.php?id_konsumen_ac= " + Rak.grab("idkonsumen")

        Log.d("TAG", urlac)

        lstHistoriac = findViewById(R.id.rvListOrderFreonR32Ac) as RecyclerView

        pglistac = findViewById(R.id.progressBarFreonR32Ac) as ProgressBar

        swipeRefreshLayout = findViewById(R.id.swipeorderfreonr32ac)
    ...
    fun ambilListOrder() {
        ...
        val request = StringRequest(Request.Method.GET, urlac, onPostsLoaded, object : Response.ErrorListener {
            override fun onErrorResponse(error: VolleyError?) {
                ...
                var inetErr: AlertDialog.Builder = AlertDialog.Builder(this@ListOrderFreonR32Ac)
                ...
                try {
                    ...
                    adapter!!.setListener(object: ItemClickListener<OrderKonsumenAc> {
                        override fun onClicked(OrderKonsumenAc: OrderKonsumenAc?, position: Int, view: View?) {
                            ...
                            val intent = Intent(this@ListOrderFreonR32Ac, DetailOrderFreonR32Konsumen::class.java)
