...
class OrderCekAcActivity : AppCompatActivity(){
    ...
    val URL_orderAc = "http://rapih.id/api/cek_ac/ordercekackonsumen.php"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        img_back = findViewById(R.id.imgbackkonfcekac)

        txt_email = findViewById(R.id.txtemailkonsumenacOrdercekac)
        ...
        txt_total = findViewById(R.id.txthargakonfcekac)
        txt_dp = findViewById(R.id.txtDetailPekerjaancekac)

        btn_req = findViewById(R.id.btnAjukanPesananCekAc)
        ...
        txt_jmlh_ac.setText(intent.getStringExtra("jumlah_ac"))
        ...
        btn_req.setOnClickListener {
            ...
            val order: String = txt_sp_cek_ac.text.toString()
            ...
            if (lokasi.length > 0 && jp.length > 0) {
                if (conMgr.activeNetworkInfo != null
                    ...
                    cekAc(id_kons,no_hp,jp,tgl,order,jmlh,desc,harga,lokasi)
                } else {
    ...
    fun cekAc(id_kons : String,no_hp : String,jp : String,tgl : String,order : String,jmlh : String,
        ...
        val stringRequest = object : StringRequest(
            ...
            Response.Listener<String> { response ->
                ...
                Log.e(TAG, "Cek Ac Order Response: $response")
                ...
                if (res.isStatus()) {
                    ...
                    val intent = Intent(this@OrderCekAcActivity, HomeKonsumenActivity::class.java)
            ...
            override fun getParams(): Map<String, String> {
                ...
                params.put("order_ac",order)
                params.put("jumlah_ac",jmlh)
                params.put("deskripsi_pekerjaan",desc)
