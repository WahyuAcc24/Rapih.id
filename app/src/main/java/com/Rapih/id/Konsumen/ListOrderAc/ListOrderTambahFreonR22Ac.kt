...
import com.Rapih.id.Konsumen.DetailOrderAC.DetailOrderFreonR22Konsumen
import com.Rapih.id.Konsumen.DetailOrderAC.DetailOrderIsiFreonR22Konsumen
...
class ListOrderTambahFreonR22Ac :AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.list_isi_freon_r22_ac)

        Rak.initialize(this)

        urlac = "http://rapih.id/api/isi_freon_r22/listorderisifreonr22konsumen.php?id_konsumen_ac= " + Rak.grab("idkonsumen")

        Log.d("TAG", urlac)

        lstHistoriac = findViewById(R.id.rvListOrderIsiFreonR22Ac) as RecyclerView

        pglistac = findViewById(R.id.progressBarIsiFreonR22Ac) as ProgressBar

        swipeRefreshLayout = findViewById(R.id.swipeorderisifreonr22ac)
    ...
    fun ambilListOrder() {
        ...
        val request = StringRequest(Request.Method.GET, urlac, onPostsLoaded, object : Response.ErrorListener {
            override fun onErrorResponse(error: VolleyError?) {
                ...
                var inetErr: AlertDialog.Builder = AlertDialog.Builder(this@ListOrderTambahFreonR22Ac)
                ...
                try {
                    ...
                    adapter!!.setListener(object: ItemClickListener<OrderKonsumenAc> {
                        override fun onClicked(OrderKonsumenAc: OrderKonsumenAc?, position: Int, view: View?) {
                            ...
                            val intent = Intent(this@ListOrderTambahFreonR22Ac, DetailOrderIsiFreonR22Konsumen::class.java)
