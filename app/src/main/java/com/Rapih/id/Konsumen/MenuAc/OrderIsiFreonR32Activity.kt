...
class OrderIsiFreonR32Activity : AppCompatActivity(){
    ...
    val URL_freonAc = "http://rapih.id/api/isi_freon_r32/orderisifreonr32konsumen.php"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.lay_konf_isi_freon_r32)


        Rak.initialize(this)

        img_back = findViewById(R.id.imgbackkonfisifreonr32)

        txt_email = findViewById(R.id.txtemailkonsumenacOrderisifreonr32)
        txt_sp_jp = findViewById(R.id.txtjenispropertiisifreonr32)
        txt_sp_freon_ac_1pk = findViewById(R.id.txtisifreonr32_1pk)
        txt_sp_freon_ac_2pk = findViewById(R.id.txtisifreonr32_2pk)
        txt_jmlh_ac = findViewById(R.id.txtjmlhisifreonr321pk)
        txt_jmlh_ac2 = findViewById(R.id.txtjmlhisifreonr32)
        txt_tgl = findViewById(R.id.txtWaktuPengerjaanisifreonr32)
        txt_total = findViewById(R.id.txthargaisifreonr32)
        txt_dp = findViewById(R.id.txtDetailPekerjaanisifreonr32)

        btn_req = findViewById(R.id.btnAjukanPesananisifreonr32)

        edt_maps_konf = findViewById(R.id.edtmapslokasiisifreonr32)
        ...
        val stringRequest = object : StringRequest(
            ...
            Response.Listener<String> { response ->
                ...
                if (res.isStatus()) {
                    ...
                    val intent = Intent(this@OrderIsiFreonR32Activity, HomeKonsumenActivity::class.java)
