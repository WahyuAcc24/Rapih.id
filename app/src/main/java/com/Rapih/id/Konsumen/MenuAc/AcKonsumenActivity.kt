...
class AcKonsumenActivity : AppCompatActivity(),AdapterView.OnItemSelectedListener,TextWatcher {
    ...
    var selectValueFreonAc: Int? = null
    ...
    var values_freon = intArrayOf(0,147000,197000,197000,247000,247000,347000,347000,447000)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sp_freon = findViewById(R.id.spinFreonAc)
        ...
        val adapterfreon = ArrayAdapter.createFromResource(
            this,
            R.array.freon_ac,
            R.layout.select_item_spin_freon
        )
        adaptercuciac.setDropDownViewResource(R.layout.item_spin_freon)
        sp_freon.setAdapter(adapterfreon)
        sp_freon.setOnItemSelectedListener(this)
        sp_freon.getBackground()
            .setColorFilter(getResources().getColor(R.color.birulain), PorterDuff.Mode.SRC_ATOP)
...
//        val total: String = txt_total.text.toString()
        ...
        btn_req.setOnClickListener {
            ...
            intent.putExtra("freon_ac", sp_freon.selectedItem.toString())
    ...
    fun setTips() {
        ...
        var edt_jml_ac = edt_jmlh.text.toString()
            ...
            if (edt_jmlh.text.toString().isNotEmpty()) {
                ...
                r = (selectValuePerbaikan!! + selectValueBongkar!! + selectValueCuciAc!! + selectValueFreonAc!!) * jumlah_ac!!
