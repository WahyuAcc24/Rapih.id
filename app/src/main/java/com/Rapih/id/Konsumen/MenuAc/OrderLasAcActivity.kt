...
class OrderLasAcActivity : AppCompatActivity(){
    ...
    private lateinit var txt_sp_las_ac_1pk: TextView
    private lateinit var txt_sp_las_ac_2pk: TextView
    ...
    val URL_lasAc = "http://rapih.id/api/las_ac/orderlasackonsumen.php"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.lay_konf_las_ac)


        Rak.initialize(this)

        img_back = findViewById(R.id.imgbackkonflasac)

        txt_email = findViewById(R.id.txtemailkonsumenacOrderlasac)
        txt_sp_jp = findViewById(R.id.txtjenispropertilasac)
        txt_sp_las_ac_1pk = findViewById(R.id.txtlasac)
        txt_sp_las_ac_2pk = findViewById(R.id.txtlasacbocor)
        txt_jmlh_ac = findViewById(R.id.txtjmlhlasac1pk)
        txt_jmlh_ac2 = findViewById(R.id.txtjmlhlasacbocor)
        txt_tgl = findViewById(R.id.txtWaktuPengerjaanlasac)
        txt_total = findViewById(R.id.txthargakonflasac)
        txt_dp = findViewById(R.id.txtDetailPekerjaanlasac)

        btn_req = findViewById(R.id.btnAjukanPesananlasAc)

        edt_maps_konf = findViewById(R.id.edtmapslokasilasac)
        ...
        txt_sp_jp.setText(intent.getStringExtra("jenis_properti_las_ac"))
        txt_sp_las_ac_1pk.setText(intent.getStringExtra("las_ac_1pk"))
        txt_sp_las_ac_2pk.setText(intent.getStringExtra("las_ac_2pk"))
        ...
        btn_req.setOnClickListener {
            ...
            val order1pk: String = txt_sp_las_ac_1pk.text.toString()
            val order2pk: String = txt_sp_las_ac_2pk.text.toString()
        ...
        fun lasAc(id_kons : String,no_hp : String,jp : String,tgl : String,order1pk : String,order2pk : String,jmlh : String, jmlh2 : String,
            ...
            val stringRequest = object : StringRequest(
                ...
                Response.Listener<String> { response ->
                    ...
                    if (res.isStatus()) {
                        ...
                        val intent = Intent(this@OrderLasAcActivity, HomeKonsumenActivity::class.java)
