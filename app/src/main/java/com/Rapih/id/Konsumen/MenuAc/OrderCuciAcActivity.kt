...
class OrderCuciAcActivity : AppCompatActivity(){
    ...
    private lateinit var txt_sp_cuci_ac_1pk: TextView
    private lateinit var txt_sp_cuci_ac_2pk: TextView
    ...
    val URL_cuciAc = "http://rapih.id/api/cuci_ac/ordercuciackonsumen.php"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.lay_konf_cuci_ac)


        Rak.initialize(this)

        img_back = findViewById(R.id.imgbackkonfcuciac)

        txt_email = findViewById(R.id.txtemailkonsumenacOrdercuciac)
        txt_sp_jp = findViewById(R.id.txtjenisproperticuciac)
        txt_sp_cuci_ac_1pk = findViewById(R.id.txtcuciac1pk)
        txt_sp_cuci_ac_2pk = findViewById(R.id.txtcuciac2pk)
        txt_jmlh_ac = findViewById(R.id.txtjmlhcuciac1pk)
        txt_jmlh_ac2 = findViewById(R.id.txtjmlhcuciac2pk)
        txt_tgl = findViewById(R.id.txtWaktuPengerjaancuciac)
        txt_total = findViewById(R.id.txthargakonfcuciac)
        txt_dp = findViewById(R.id.txtDetailPekerjaancuciac)

        btn_req = findViewById(R.id.btnAjukanPesanancuciAc)

        edt_maps_konf = findViewById(R.id.edtmapslokasicuciac)
        ...
        txt_sp_jp.setText(intent.getStringExtra("jenis_properti_cuci_ac"))
        txt_sp_cuci_ac_1pk.setText(intent.getStringExtra("cuci_ac_1pk"))
        txt_sp_cuci_ac_2pk.setText(intent.getStringExtra("cuci_ac_2pk"))
        ...
        btn_req.setOnClickListener {
            ...
            val order1pk: String = txt_sp_cuci_ac_1pk.text.toString()
            val order2pk: String = txt_sp_cuci_ac_2pk.text.toString()
    ...
    fun cuciAc(id_kons : String,no_hp : String,jp : String,tgl : String,order1pk : String,order2pk : String,jmlh : String, jmlh2 : String,
        ...
        val stringRequest = object : StringRequest(
            Request.Method.POST, URL_cuciAc,
            Response.Listener<String> { response ->
                ...
                if (res.isStatus()) {
                    ...
                    val intent = Intent(this@OrderCuciAcActivity, HomeKonsumenActivity::class.java)
