...
class IsiUlangFreonR22Activity : AppCompatActivity(),AdapterView.OnItemSelectedListener,
    TextWatcher {
    ...
    private lateinit var sp_freon_r22: Spinner
    private lateinit var sp_freon_r22_2pk: Spinner
    ...
    private var values_freon = intArrayOf(0,147000)
    private var values_freon2 = intArrayOf(0,197000)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.lay_isi_freon_r22_konsumen)

        Rak.initialize(this)


        img_back = findViewById(R.id.imgbackisifreonr22)
        txt_email = findViewById(R.id.txtemailacisifreonr22)
        sp_jp = findViewById(R.id.spinProIsiR22Ac)
        sp_freon_r22 = findViewById(R.id.spinIsiFreonAcR22)
        sp_freon_r22_2pk = findViewById(R.id.spinIsiFreonAcR22_2pk)

        txt_jmlh = findViewById(R.id.txtjumlahisifreonr22)
        txt_jmlh2 = findViewById(R.id.txtjumlahisifreonr22_2pk)



        btn_req = findViewById(R.id.btnlanjutisifreon)
        edt_tgl = findViewById(R.id.edttglisifreonac)
        txt_total = findViewById(R.id.txthargaisifreonac)

        edt_maps_ac = findViewById(R.id.edtmapsisifreonac)
        edt_dp = findViewById(R.id.edtdescisifreonac)

        btn_minus = findViewById(R.id.btnminusisir22)
        btn_minus2 = findViewById(R.id.btnminusisir22_2pk)
        btn_plus = findViewById(R.id.btnplusisir22)
        btn_plus2 = findViewById(R.id.btnplusisiR22_2pk)
        ...
        val adapterfreon1pk = ArrayAdapter.createFromResource(
            this,
            R.array.tambah_freon_r22_1pk,
            R.layout.select_item_spin_freon
        )
        adapterfreon1pk.setDropDownViewResource(R.layout.item_spin_freon)
        sp_freon_r22.setAdapter(adapterfreon1pk)
        sp_freon_r22.setOnItemSelectedListener(this)
        sp_freon_r22.getBackground()
            .setColorFilter(getResources().getColor(R.color.birulain), PorterDuff.Mode.SRC_ATOP)

        val adapterfreon2pk = ArrayAdapter.createFromResource(
            this,
            R.array.tambah_freon_r22_2pk,
            R.layout.select_item_spin_freon
        )
        adapterfreon2pk.setDropDownViewResource(R.layout.item_spin_freon)
        sp_freon_r22_2pk.setAdapter(adapterfreon2pk)
        sp_freon_r22_2pk.setOnItemSelectedListener(this)
        sp_freon_r22_2pk.getBackground()
            .setColorFilter(getResources().getColor(R.color.birulain), PorterDuff.Mode.SRC_ATOP)
        ...
        btn_req.setOnClickListener {
            ...
            val intent: Intent = Intent(this@IsiUlangFreonR22Activity, OrderIsiFreonR22Activity::class.java)
            intent.putExtra("jenis_properti_freon_ac", sp_jp.selectedItem.toString())
            intent.putExtra("freon_ac_1pk", sp_freon_r22.selectedItem.toString())
            intent.putExtra("freon_ac_2pk", sp_freon_r22_2pk.selectedItem.toString())
    ...
    override fun onItemSelected(arg0: AdapterView<*>, arg1: View, arg2: Int, id: Long) {
        ...
        if (arg0.id == R.id.spinIsiFreonAcR22) {
            selectValueFreon1Pk = values_freon[arg2]

        };if (arg0.id == R.id.spinIsiFreonAcR22_2pk) {
