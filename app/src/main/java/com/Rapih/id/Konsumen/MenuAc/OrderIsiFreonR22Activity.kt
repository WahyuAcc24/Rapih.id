...
class OrderIsiFreonR22Activity : AppCompatActivity(){
    ...
    val URL_freonAc = "http://rapih.id/api/isi_freon_r22/orderisifreonr22konsumen.php"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.lay_konf_isi_freon_r22)


        Rak.initialize(this)

        img_back = findViewById(R.id.imgbackkonfisifreonr22)

        txt_email = findViewById(R.id.txtemailkonsumenacOrderisifreonr22)
        txt_sp_jp = findViewById(R.id.txtjenispropertiisifreonr22)
        txt_sp_freon_ac_1pk = findViewById(R.id.txtisifreonr22_1pk)
        txt_sp_freon_ac_2pk = findViewById(R.id.txtisifreonr22_2pk)
        txt_jmlh_ac = findViewById(R.id.txtjmlhisifreonr221pk)
        txt_jmlh_ac2 = findViewById(R.id.txtjmlhisifreonr22)
        txt_tgl = findViewById(R.id.txtWaktuPengerjaanisifreonr22)
        txt_total = findViewById(R.id.txthargaisifreonr22)
        txt_dp = findViewById(R.id.txtDetailPekerjaanisifreonr22)

        btn_req = findViewById(R.id.btnAjukanPesananisifreonr22)

        edt_maps_konf = findViewById(R.id.edtmapslokasiisifreonr22)
        ...
        val stringRequest = object : StringRequest(
            ...
            Response.Listener<String> { response ->
                ...
                if (res.isStatus()) {
                    ...
                    val intent = Intent(this@OrderIsiFreonR22Activity, HomeKonsumenActivity::class.java)
