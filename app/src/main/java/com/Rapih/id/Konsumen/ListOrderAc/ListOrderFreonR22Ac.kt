...
class ListOrderFreonR22Ac :AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.list_freon_r22_ac)

        Rak.initialize(this)

        urlac = "http://rapih.id/api/freon_r22/listorderfreonr22konsumen.php?id_konsumen_ac= " + Rak.grab("idkonsumen")

        Log.d("TAG", urlac)

        lstHistoriac = findViewById(R.id.rvListOrderFreonR22Ac) as RecyclerView

        pglistac = findViewById(R.id.progressBarFreonR22Ac) as ProgressBar

        swipeRefreshLayout = findViewById(R.id.swipeorderfreonr22ac)
    ...
    fun ambilListOrder() {
        ...
        val request = StringRequest(Request.Method.GET, urlac, onPostsLoaded, object : Response.ErrorListener {
            override fun onErrorResponse(error: VolleyError?) {
                ...
                var inetErr: AlertDialog.Builder = AlertDialog.Builder(this@ListOrderFreonR22Ac)
                ...
                try {
                    ...
                    adapter!!.setListener(object: ItemClickListener<OrderKonsumenAc> {
                        override fun onClicked(OrderKonsumenAc: OrderKonsumenAc?, position: Int, view: View?) {
                            ...
                            val intent = Intent(this@ListOrderFreonR22Ac, DetailOrderFreonR22Konsumen::class.java)
