...
class ListOrderCekAc :AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        urlac = "http://rapih.id/api/cek_ac/listordercekackonsumen.php?id_konsumen_ac= " + Rak.grab("idkonsumen")
    ...
    fun ambilListOrder() {
        ...
        val request = StringRequest(Request.Method.GET, urlac, onPostsLoaded, object : Response.ErrorListener {
            override fun onErrorResponse(error: VolleyError?) {
                ...
                var inetErr: AlertDialog.Builder = AlertDialog.Builder(this@ListOrderCekAc)
