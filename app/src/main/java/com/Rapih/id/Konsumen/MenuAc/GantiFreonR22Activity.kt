...
class GantiFreonR22Activity : AppCompatActivity(),AdapterView.OnItemSelectedListener, TextWatcher {
    ...
    private var values_freon = intArrayOf(0,247000)
    private var values_freon2 = intArrayOf(0,347000)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.lay_freon_r22_konsumen)


        Rak.initialize(this)


        img_back = findViewById(R.id.imgbackfreonr22)
        txt_email = findViewById(R.id.txtemailacfreonr22)
        sp_jp = findViewById(R.id.spinProR22Ac)
        sp_freon_r22 = findViewById(R.id.spinFreonAcR22)
        sp_freon_r22_2pk = findViewById(R.id.spinFreonAcR22_2pk)

        txt_jmlh = findViewById(R.id.txtjumlahfreonr22)
        txt_jmlh2 = findViewById(R.id.txtjumlahfreonr22_2pk)



        btn_req = findViewById(R.id.btnlanjutfreon)
        edt_tgl = findViewById(R.id.edttglfreonac)
        txt_total = findViewById(R.id.txthargafreonac)

        edt_maps_ac = findViewById(R.id.edtmapsfreonac)
        edt_dp = findViewById(R.id.edtdescfreonac)

        btn_minus = findViewById(R.id.btnminusr22)
        btn_minus2 = findViewById(R.id.btnminusr22_2pk)
        btn_plus = findViewById(R.id.btnplusr22)
        btn_plus2 = findViewById(R.id.btnplusR22_2pk)
        ...
        btn_req.setOnClickListener {
            ...
            val intent: Intent = Intent(this@GantiFreonR22Activity, OrderFreonR22Activity::class.java)
    ...
    override fun onItemSelected(arg0: AdapterView<*>, arg1: View, arg2: Int, id: Long) {
        ...
        if (arg0.id == R.id.spinFreonAcR22) {
            selectValueFreon1Pk = values_freon[arg2]

        };if (arg0.id == R.id.spinFreonAcR22_2pk) {
