...
class OrderFreonR22Activity : AppCompatActivity(){
    ...
    val URL_freonAc = "http://rapih.id/api/freon_r22/orderfreonr22konsumen.php"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        txt_jmlh_ac = findViewById(R.id.txtjmlhfreonr221pk)
        txt_jmlh_ac2 = findViewById(R.id.txtjmlhfreonr22)
        ...
        val stringRequest = object : StringRequest(
            ...
            Response.Listener<String> { response ->
                ...
                if (res.isStatus()) {
                    ...
                    val intent = Intent(this@OrderFreonR22Activity, HomeKonsumenActivity::class.java)
