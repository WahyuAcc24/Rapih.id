...
class ListOrderTambahFreonR32Ac :AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.list_isi_freon_r32_ac)

        Rak.initialize(this)

        urlac = "http://rapih.id/api/isi_freon_r32/listorderisifreonr32konsumen.php?id_konsumen_ac= " + Rak.grab("idkonsumen")

        Log.d("TAG", urlac)

        lstHistoriac = findViewById(R.id.rvListOrderIsiFreonR32Ac) as RecyclerView

        pglistac = findViewById(R.id.progressBarIsiFreonR32Ac) as ProgressBar

        swipeRefreshLayout = findViewById(R.id.swipeorderisifreonr32ac)
    ...
    fun ambilListOrder() {
        ...
        val request = StringRequest(Request.Method.GET, urlac, onPostsLoaded, object : Response.ErrorListener {
            override fun onErrorResponse(error: VolleyError?) {
                ...
                var inetErr: AlertDialog.Builder = AlertDialog.Builder(this@ListOrderTambahFreonR32Ac)
                ...
                try {
                    ...
                    adapter!!.setListener(object: ItemClickListener<OrderKonsumenAc> {
                        override fun onClicked(OrderKonsumenAc: OrderKonsumenAc?, position: Int, view: View?) {
                            ...
                            val intent = Intent(this@ListOrderTambahFreonR32Ac, DetailOrderIsiFreonR22Konsumen::class.java)
